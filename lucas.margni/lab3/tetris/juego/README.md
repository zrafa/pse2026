...
* <kbd>a</kbd> and <kbd>d</kbd>: Move the tetromino,
* <kbd>w</kbd>: Rotate (clockwise?) the tetromino,
* <kbd>s</kbd>: Immediately drop the tetromino (not a fast drop, an immediate drop),
...
* <kbd>e</kbd>: Save game and exit (just assumes filename `tetris.save`).  To resume the
