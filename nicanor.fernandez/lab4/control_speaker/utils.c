...
void reproducir_frecuencia(int frecuencia){
	// calculamos cuantos periodos hay en medio segundo para la nota dada
	int duracion_us = 10000;

	if(frecuencia == 0){
		_delay_us(duracion_us);
	}

	int cant_rep = (int) frecuencia * duracion_us / 1000;
	int i;

	int medio_periodo = (1000000 / frecuencia) / 2;
